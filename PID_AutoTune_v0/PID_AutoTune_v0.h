...
#define ATUNE_RUNNING_NOOP 0
#define ATUNE_RUNNING_NEW_OUTPUT 1
#define ATUNE_FINISHED 2
...
public:
	...
	int ExtendedRuntime(); // * Runtime() with return codes
	void CancelAutoTune(); // * Stops the AutoTune
